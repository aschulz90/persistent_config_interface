 ...
 *  Modified by Andreas Schulz (https://github.com/aschulz90) for better formating
*/
module.exports = function (object, filter, indent, startingIndent) {
  ...
  function walk (object, filter, indent, currentIndent, seen) {
    ...
    if (Array.isArray(object)) {
      return '[\n' + currentIndent + indent + join(object.map(function (element) {
        return walk(element, filter, indent, nextIndent, seen.slice())
      })) + '\n' + currentIndent + ']'
    }
    var keys = Object.keys(object)
    return keys.length ? '{\n' + currentIndent + indent + join(keys.map(function (key) {
